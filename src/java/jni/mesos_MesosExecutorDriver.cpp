...
public:
  ...
  virtual void init(ExecutorDriver*, const ExecutorArgs&);
  virtual void launchTask(ExecutorDriver*, const TaskDescription&);
  virtual void killTask(ExecutorDriver*, TaskID);
  virtual void frameworkMessage(ExecutorDriver*, const FrameworkMessage&);
  virtual void shutdown(ExecutorDriver*);
  virtual void error(ExecutorDriver*, int code, const string& message);
...
void JNIExecutor::killTask(ExecutorDriver* driver, TaskID taskId)
{
  jvm->AttachCurrentThread((void **) &env, NULL);
  ...
  jmethodID killTask = env->GetMethodID(clazz, "killTask",
    "(Lmesos/ExecutorDriver;Lmesos/TaskID;)V");
...
void JNIExecutor::frameworkMessage(ExecutorDriver* driver, const FrameworkMessage& message)
{
  ...
  jmethodID frameworkMessage = env->GetMethodID(clazz, "frameworkMessage",
    "(Lmesos/ExecutorDriver;Lmesos/FrameworkMessage;)V");
